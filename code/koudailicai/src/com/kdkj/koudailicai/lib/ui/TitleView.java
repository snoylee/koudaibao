...
public class TitleView extends RelativeLayout {
	...
	public void initSize() {
		int screenHeight = Integer.parseInt(KDLCApplication.app.getSession().get("screenHeight"));
		int titleHeight = (int) (screenHeight*0.08);
		RelativeLayout.LayoutParams titleViewParams = (RelativeLayout.LayoutParams) titleView.getLayoutParams();
