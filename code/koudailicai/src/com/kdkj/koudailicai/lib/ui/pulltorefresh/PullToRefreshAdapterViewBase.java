...
import com.kdkj.koudailicai.lib.ui.pulltorefresh.base.EmptyViewMethodAccessor;
import com.kdkj.koudailicai.lib.ui.pulltorefresh.base.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		if (getShowIndicatorInternal()) {
			Log.d(LOG_TAG, "updateIndicatorViewsVisibility:");
			updateIndicatorViewsVisibility();
		}
		Log.d(LOG_TAG, "mOnScrollListener2222:");
	...
	public final void onScrollStateChanged(final AbsListView view, final int state) {
		 ...
		 * visible.
		 */
		Log.d(LOG_TAG,"onScrollStateChanged:"+state);
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		Log.d(LOG_TAG, "isPullToRefreshOverScrollEnabled():"+isPullToRefreshOverScrollEnabled());
	...
	private void addIndicatorViews() {
		Log.d(LOG_TAG, "addIndicatorViews");
		Mode mode = getMode();
		FrameLayout refreshableViewWrapper = getRefreshableViewWrapper();
	...
	private boolean getShowIndicatorInternal() {
		Log.d(LOG_TAG, "getShowIndicatorInternal:"+(mShowIndicator && isPullToRefreshEnabled()));
	...
	private boolean isLastItemVisible() {
		Log.d(LOG_TAG, "isLastItemVisible");
		final Adapter adapter = mRefreshableView.getAdapter();
