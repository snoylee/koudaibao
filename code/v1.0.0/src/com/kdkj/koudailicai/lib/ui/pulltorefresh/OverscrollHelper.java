...
import com.kdkj.koudailicai.lib.ui.pulltorefresh.PullToRefreshBase.State;
	...
	public static void overScrollBy(final PullToRefreshBase<?> view, final int deltaX, final int scrollX,
		...
		switch (view.getPullToRefreshScrollDirection()) {
			...
			default:
				...
				Log.d(LOG_TAG, "overScrollBy currentScrollValue:"+currentScrollValue);
				break;
		}
		...
		if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
			...
			// touch
			Log.d(LOG_TAG, "permitsPullToRefresh:"+mode.permitsPullToRefresh());
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				final int newScrollValue = (deltaValue + scrollValue);
				Log.d(LOG_TAG, "newScrollValue:"+newScrollValue);
