 ...
 *******************************************************************************/
package com.kdkj.koudailicai.lib.ui.pulltorefresh;
...
import com.kdkj.koudailicai.lib.ui.pulltorefresh.base.FlipLoadingLayout;
import com.kdkj.koudailicai.lib.ui.pulltorefresh.base.LoadingLayout;
import com.kdkj.koudailicai.lib.ui.pulltorefresh.base.RotateLoadingLayout;
import com.kdkj.koudailicai.lib.ui.pulltorefresh.base.Utils;
import com.kdkj.koudailicai.lib.ui.pulltorefresh.base.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public PullToRefreshBase(Context context) {
		super(context);
		init(context, null);
		Log.d(LOG_TAG, "PullToRefreshBase(Context context)");
	}

	public PullToRefreshBase(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
		Log.d(LOG_TAG, "PullToRefreshBase(Context context, AttributeSet attrs)");
	}
	...
	public PullToRefreshBase(Context context, Mode mode) {
		...
		mMode = mode;
		init(context, null);
		Log.d(LOG_TAG, "PullToRefreshBase(Context context, Mode mode)");
	}
	...
	public PullToRefreshBase(Context context, Mode mode, AnimationStyle animStyle) {
		...
		init(context, null);
		Log.d(LOG_TAG, "PullToRefreshBase(Context context, Mode mode, AnimationStyle animStyle)");
	}
    ...
    public void doPullRefreshing(final boolean smoothScroll, final long delayMillis) {
    	Log.d(LOG_TAG, "doPullRefreshing");
	...
	public final void showPullLine(boolean isShow) {
		mHeaderLayout.showPullLine(isShow);
	}
	
	public final void setCurrentMode(Mode curMode) {
		Log.d(LOG_TAG, "setCurrentMode");
		mCurrentMode = curMode;
	}
	
	@Override
	public final Mode getCurrentMode() {
		Log.d(LOG_TAG, "getCurrentMode");
		return mCurrentMode;
	}

	@Override
	public final boolean getFilterTouchEvents() {
		Log.d(LOG_TAG, "getFilterTouchEvents");
		return mFilterTouchEvents;
	}

	@Override
	public final ILoadingLayout getLoadingLayoutProxy() {
		Log.d(LOG_TAG, "getLoadingLayoutProxy()");
	...
	public final Mode getMode() {
		Log.d(LOG_TAG, "getMode:"+mMode);
		return mMode;
	}

	@Override
	public final T getRefreshableView() {
		Log.d(LOG_TAG, "getRefreshableView");
		return mRefreshableView;
	}

	@Override
	public final boolean getShowViewWhileRefreshing() {
		Log.d(LOG_TAG, "getShowViewWhileRefreshing");
	...
	public final boolean isDisableScrollingWhileRefreshing() {
		Log.d(LOG_TAG, "isDisableScrollingWhileRefreshing");
		return !isScrollingWhileRefreshingEnabled();
	}

	@Override
	public final boolean isPullToRefreshEnabled() {
		Log.d(LOG_TAG, "isPullToRefreshEnabled");
		return mMode.permitsPullToRefresh();
	}

	@Override
	public final boolean isPullToRefreshOverScrollEnabled() {
		Log.d(LOG_TAG, "isPullToRefreshOverScrollEnabled:"+(VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD && mOverScrollEnabled
	...
	public final boolean isRefreshing() {
		Log.d(LOG_TAG, "isRefreshing():"+mState);
		return mState == State.REFRESHING || mState == State.MANUAL_REFRESHING;
	}

	@Override
	public final boolean isScrollingWhileRefreshingEnabled() {
		Log.d(LOG_TAG, "isScrollingWhileRefreshingEnabled");
	...
	public final boolean onInterceptTouchEvent(MotionEvent event) {
		...
		Log.d(LOG_TAG, "onInterceptTouchEvent2");
		if (action != MotionEvent.ACTION_DOWN && mIsBeingDragged) {
			return true;
		}
		Log.d(LOG_TAG, "onInterceptTouchEvent3");
		switch (action) {
			case MotionEvent.ACTION_MOVE: {
				Log.d(LOG_TAG, "onInterceptTouchEvent ACTION_MOVE");
			...
			case MotionEvent.ACTION_UP: {
				Log.d(LOG_TAG, "onInterceptTouchEvent ACTION_UP");
				Log.d(LOG_TAG, "up");
				break;
			}
		}
	...
	public final void setLoadRefreshing() {
		setState(State.REFRESHING, true);	
	}
	...
	private final void smoothScrollTo(int newScrollValue, long duration, long delayMillis,
		...
		if (oldScrollValue != newScrollValue) {
			if (null == mScrollAnimationInterpolator) {
				...
				mScrollAnimationInterpolator = new AccelerateInterpolator();
			}
